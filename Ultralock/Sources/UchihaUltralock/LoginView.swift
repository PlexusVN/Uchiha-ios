...
struct LoginView: View {
                ...
                VStack(spacing: 20) {
                    ...
                    CyberCard {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            adminRow(icon: "person.fill", name: "Minh Khải", phone: "0342145707")
                            adminRow(icon: "person.fill", name: "Trần Việt Anh", phone: "0377045762")
                        }
                    }
    ...
    private func adminRow(icon: String, name: String, phone: String) -> some View {
        HStack(spacing: 10) {
            ZStack {
                Circle()
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text(phone)
                    ...
                    .foregroundColor(Color(hex: 0xCC4444))
            }
            ...
            Button(action: {
                ...
                viewModel.showToast("Đã sao chép số \(name)")
            }) {
